...
overall_health_status <- fread("data/overall_health_status.csv") |> 
  mutate(
    ...
    theme = c(
      "primary", "primary", "danger", "danger", "danger",
      "danger", "danger", "danger", "danger", "danger",
      "warning", "warning", "danger", "warning", "info",
...
overall_progress_uhc <- fread("data/overall_progress_uhc.csv") |> 
  mutate(
    ...
    theme = c("info", "warning", "success", "primary"),
    color = c("teal", "orange", "green", "blue")
  )
...
access_health_services <- fread("data/access_health_services.csv") |> 
  mutate(
    ...
    theme = c("success", "warning", "primary", "info", "info"),
    color = c("green", "orange", "blue", "teal", "navy")
  )
